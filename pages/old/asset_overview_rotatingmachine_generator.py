            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(
                            id='button-container_analysis_generator',
                            style={"margin-top": "20px", "text-align": "center", "display": "flex", "justify-content": "center"},
                            children = [
                                html.Button('Update Risk assessment', id='risk_assessment_btn_generator', style={ 'width':'300px', 'background-color':'grey', 'border-color':'grey','color': 'black', 'font-weight': 'bold'}),
                        ...
                        html.Div(
                            ...
                            style={"margin-top": "20px", "text-align": "center", "display": "flex", "justify-content": "center"},
                            children = [
                                html.Button('Export Latest assessment', id='export_assessment', style={ 'width':'300px', 'background-color':'grey', 'border-color':'grey','color': 'black', 'font-weight': 'bold'}),
                        ...
                        #
                        html.Div(id='voice_control_output', style={'display': 'none'}),
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(className='image-container', style={'display': 'flex', 'justify-content': 'center', 'align-items': 'center', 'height': '100%','z-index': 1, 'margin-top':'150px'},
                                ...
                                html.Div(id='circle1_stator', className='circle',  children=[
                                    html.Span(id='circle1number_stator',children="1", className="circle-number", style={"color": "white"},
                                ...
                                html.Div(id='circle2_rotor', className='circle',
                                         children=[html.Span(id='circle2number_rotor', children="2", className="circle-number", style={"color": "white"},
                                ...
                                html.Div(id='circle3_aux', className='circle', children=[
                                    html.Span(id='circle3number_aux',children="3", className="circle-number", style={"color": "white"},
                ...
                html.Div(
                    ...
                    children=[
                        html.H5('Do you want to update the risk assessment?',
                                id='risk_assessment_title_generator',
                                style={'color': 'black', 'font-weight': 'bold', "text-align": "center"}),
                        # html.Div(
...
@callback(
    Output('content-gen', 'children'),
    Input('store', 'data'),
    prevent_initial_call='initial_duplicate'
)
def display_selected_asset(selected_asset):
    # print('here',selected_asset)
    # asset_selected_details = []
...
@callback(
    ...
    Output('circle1number_stator', 'children', allow_duplicate=True),
    Output('circle1_stator', 'style', allow_duplicate=True),
    Output('circle2number_rotor', 'children', allow_duplicate=True),
    Output('circle2_rotor', 'style', allow_duplicate=True),
    ...
    Output('complete_maintenance_table', 'data', allow_duplicate=True),
    # Input('content-gen', 'children'),
...
def update_asset_info(store):
    ...
    if len(asset_selected_details)!=0:
        ...
        try:
            ...
            component_analysis =[(1,0,1,0), (2,0,2,0), (3,0,3,0)]
        ...
        try:
            ...
            for fms in failure_mechanism_list:
                temp = [0, 0, fms[0], 0]
                failure_mechanism_analysis.append(temp)

        if len(failure_mechanism_analysis)==0:
            failure_mechanism_analysis = []
            for fms in failure_mechanism_list:
                temp = [0, 0, fms[0], 0]
                failure_mechanism_analysis.append(temp)
        ...
        layout = go.Layout(
                title={
                        ...
                        'xanchor': 'center'},
                xaxis={'tickfont': {'color': 'white', 'size':10}, 'showgrid': False, 'tickangle':45,'tickvals':risk_date_trend[::5]},
...
def toggle_modal(open_clicks, close_clicks, save_clicks, current_style, selected_value):
    ...
    if trigger_id == 'open_modal_btn' and open_clicks:
        ...
        criticality_id = int(selected_value)


        update_asset_criticality(criticality_id,asset_id,formatted_date )
...
def toggle_modal(update_risk_clicks, close_clicks, save_clicks, current_style,button_disabled, complete_risk_style, close_name):
    ...
    if trigger_id == 'risk_assessment_btn_generator' and update_risk_clicks:
        current_style['display'] = 'block'
        ...
        try:
            ...
            latest_assessment_date_str = None
        ...
        if latest_assessment_date ==None:
            assess_condition(asset_id)
            message = 'Risk assessment updated!'
        elif latest_assessment_date < formatted_date:
            assess_condition(asset_id)
            message = 'Risk assessment updated!'
...
@callback(
    ...
    Input('export_assessment', 'n_clicks'),
    prevent_initial_call=True
)

...
from connectors.db_connectors_mysql import upload_test_data_cable, insert_online_pd_data
...
layout = html.Div(
    ...
    children=[
        ...
        html.Div(id='content-cable'),
        dcc.Location(id='url_labels_sniffer_page'),
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.P(id="Username_sniffer_page"),
                        # html.P(id='Function'),
                        html.P(id='Datetime_sniffer_page'),
                        html.Br(),
                        html.Br(),
                        html.Br(),
                        html.Div(
                            ...
                            children = [
                                html.Button('Start/Stop', id='start_stop_button_sniffer_page', style={ 'width':'300px', 'background-color':'grey', 'border-color':'grey','color': 'black', 'font-weight': 'bold'}),
                        ...
                        html.Div(
                            ...
                            style={"margin-top": "20px", "text-align": "center", "display": "flex", "justify-content": "center"},
                            children = [
                                html.Button('Download', id='download_button_sniffer_page', style={ 'width':'300px', 'background-color':'grey', 'border-color':'grey','color': 'black', 'font-weight': 'bold'}),
                        ...
                        html.Div(
                            ...
                            children=[
                                html.Div(
                                    ...
                                    children=[
                                        html.P(id='modal-message', style={'font-size': '18px', 'color': 'red'}),
                        ...
                        html.Div(
                            ...
                            children=[
                                html.Div(
                                    ...
                                    children=[
                                        html.P(id='modal1-message', style={'font-size': '18px', 'color': 'green'}),
                                        html.Button('Close', id='close-modal1', n_clicks=0)
                                    ]
                                )
                            ]
                        ),
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.Br(),
                        html.Br(),
                        html.P(id="messages_received",children="Messages received: 0",
...
@callback(
    Output("Username_sniffer_page", "children"),
    Output('Datetime_sniffer_page', 'children'),
    Input("url_labels_sniffer_page", "pathname")
    )
...
#Update messages when start

#Sniffer mode
@callback(
    [Output('start_stop_button_sniffer_page', 'style'),
     Output('messages_received', 'children',allow_duplicate=True),
     Output('message_interval', 'disabled'),
     Output('download_button', 'disabled', allow_duplicate=True)],
    [Input('start_stop_button_sniffer_page', 'n_clicks')],
    [State('start_stop_button_sniffer_page', 'style')],
...
@callback(
    Output('messages_received', 'children', allow_duplicate=True),
    [Input('message_interval', 'n_intervals')],
    prevent_initial_call=True,
)
...
@callback(
    [Output('modal1', 'style',allow_duplicate=True),
     Output('modal1-message', 'children'),

...
layout = html.Div(
    ...
    children=[
        ...
        html.Div(id='content-switchgear-sf6'),
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.P(id="YOM"),
                        html.P(id='YOI'),
                        html.Div(id='dummy_gs', style={'display': 'none'}),
                        html.Br(),
                        ...
                        html.Div(
                            id='button-container_analysis_sf6',
...
@callback(
    Output('content-switchgear-sf6', 'children', allow_duplicate=True),
    Input('store', 'data'),
...
#     Output('complete_maintenance_table', 'data'),
...
#         if store['key']['points'][0]['customdata'][24] !=3:
#

...
from connectors.db_connectors_mysql import get_component_analysis, get_component_single_asset_list, \
    get_site_asset_layout_individual_cable, get_single_asset_tag, get_single_asset_characteristics, \
    get_online_test_analysis_data_full_asset, get_offline_test_analysis_data_full_asset, \
    get_offline_latest_JT_value_for_summary_table, get_offline_latest_IR_value_for_summary_table, \
    get_offline_latest_PI_value_for_summary_table, get_offline_latest_TD_value_for_summary_table, \
    get_online_pd_patter_cable
...
from connectors.db_connectors_mysql import upload_test_data_cable
from connectors.db_connectors_mysql import get_online_pd_test_data_cable
...
data_complete_asset_action = [
    {"Phase": "", "Core": "", "Latest update":"", "Insulation Resistance [GΩ]":"", "Polarization Index":"", "Jacket":"", "VLF TD @Uo":"", "Partial Discharge":""},
...
layout = html.Div(
    ...
    children=[
        ...
        html.Div(id='content-cable-raw-data'),
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.P(id="YOM"),
                        html.P(id='YOI'),
                        html.Div(id='dummy_cb', style={'display': 'none'}),
                        html.Div(id='dummy_table_raw_data_cable', style={'display': 'none'}),
                        html.Br(),
                        ...
                        html.Br(),
                        html.Div(
                            id='insert_data_cable',
                            style={"margin-top": "20px", "text-align": "center", "display": "flex", "justify-content": "center"},
                            children = [
                                html.Button('Insert new test record', id='open_modal_btn1_cb', style={ 'width':'300px', 'background-color':'grey', 'border-color':'grey','color': 'black', 'font-weight': 'bold'}),

                            ]
                        ),
                        html.Br(),
                        html.Div(
                            id='button-container_analysis_cb',
                            style={"margin-top": "20px", "text-align": "center", "display": "flex", "justify-content": "center"},
                            children = [
                                html.Button('Update Risk assessment', id='risk_assessment_bottom_cb', style={ 'width':'300px', 'background-color':'grey', 'border-color':'grey','color': 'black', 'font-weight': 'bold'}),
                        ...
                        html.Div(
                            ...
                            style={"margin-top": "20px", "text-align": "center", "display": "flex", "justify-content": "center"},
                            children = [
                                html.Button('Export Latest assessment', id='export_assessment_cb', style={ 'width':'300px', 'background-color':'grey', 'border-color':'grey','color': 'black', 'font-weight': 'bold'}),
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.Br(),
                        # id='circle3number_join'html.H3("Executive Summary", style={'display': 'flex', 'justify-content': 'center'}),

                        html.Br(),

                        html.Div(className='image-container',
                                 style={'display': 'flex', 'justify-content': 'center', 'align-items': 'center',
                                        'height': '100%', 'z-index': 1, 'margin-top': '150px'},
                                 children=[
                                     html.Img(
                                         src=dash.get_asset_url('cable_overview_nojoint_mv.png'),
                                         # Replace with your image path
                                         style={'max-width': 'auto', 'height': 'auto', 'position': 'absolute',
                                                'top': '0', "object-fit": "cover", 'margin-top': '50px',
                                                'border-radius': '15px'}
                                         # style={'max-width': '100%', 'height': 'auto', 'position': 'relative'}
                                     ),
                                     html.Div(id='circle1_termination', className='circle', children=[
                                         html.Span(id='circle1number_termination', children="1",
                                                   className="circle-number", style={"color": "white"},
                                     ...
                                     html.Div(id='circle2_section', className='circle',
                                              children=[html.Span(id='circle2number_section', children="2",
                                                                  className="circle-number", style={"color": "white"},
                                     ...
                                     html.Div(id='circle3_join', className='circle', children=[
                                         html.Span(id='circle3number_join', children="3", className="circle-number",
                                                   style={"color": "white"},
                        ...
                        html.Div(
                            ...
                            children=[
                                DataTable(
                                    id='raw_data_summary_cb',
                                    columns=[
                                        {"name": "Phase", "id": "phase"},
                                        {"name": "Core", "id": "core_number"},
                                        {"name": "Latest update", "id": "latest_test_date"},
                                        {"name": "Insulation Resistance [GΩ]", "id": "latest_ir"},
                                        {"name": "Polarization Index", "id": "latest_pi"},
                                        {"name": "Jacket Test Passed", "id": "latest_jacket"},
                                        {"name": "VLF TD @Uo [10E-10]", "id": "latest_td"},
                                        {"name": "Partial Discharge", "id": "latest_pd"},
                                    ],
                                    data=data_complete_asset_action,
                        ...
                        html.Div(id='complete_maintenance_table_cb', style={'display': 'none'}),
                        ...
                        dbc.Container(fluid=True,
                                      ...
                                      children=[
                                          ...
                                          dbc.Row([
                                              dbc.Col(dbc.Button("Online Results Trend", id="online-button-cable",
                                                                 color="primary", className="mb-3"), width=10,
                                                      style={'margin-bottom': '20px'}),
                                              dbc.Col(dbc.Button("Offline Results Trend", id="offline-button-cable",
                                                                 color="primary", className="mb-3"), width=10),

                                          ]),

                                          dbc.Row([
                                              dbc.Col(id='online-container-cable', width=12, style={'margin-bottom': '10px'}),
                                              dbc.Col(id='offline-container-cable', width=12,
                        ...
                        dbc.Container(
                            id='raw-data-graph-container-cable',
                            style={'display': 'block', 'padding': '10px', 'width': '100%', 'margin-top': '10px'}  # Initial style can be hidden
                        ),
    ...
    html.Div(id='complete_risk_assessment_sw', style={'display': 'none'}),
    html.Div(id='risk_assessment_sw', style={'display': 'none'}),
    html.Div(id='close_risk_assessment_sw', style={'display': 'none'}),
            ...
            children=[
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(
                            children=[
                                html.Button('Next', id='open_modal_btn2_cb',
                                            style={'color': 'black', 'width': '100px', 'margin-top': '10px',
                                                   'background-color': 'green', 'border-color': 'grey',
                                                   'text-align': 'center', 'opacity': 0.9, 'margin-right': '40px'}),
                                html.Button('Cancel', id='close_modal_btn1_cb',
                                            style={'color': 'black', 'width': '100px', 'margin-top': '10px',
                                                   'background-color': 'red', 'border-color': 'grey',
                                                   'text-align': 'center', 'opacity': 0.9}),
                            ],
    ...
    html.Div(
            id='Insert_data_cable_data2',
            style={'display': 'none', 'position': 'fixed', 'top': '50%', 'left': '50%',
                   'transform': 'translate(-50%, -50%)', 'z-index': 1000},
            children=[
                html.Div(
                    id='modal_content2_cb',
                    style={'background-color': 'white', 'padding': '20px', 'border': '1px solid #ccc',
                           'border-radius': '5px'},
                    children=[
                        ...
                        html.Div(
                            children=[
                                html.Button('Next', id='open_modal_btn3_cb',
                                            style={'color': 'black', 'width': '100px', 'margin-top': '10px',
                                                   'background-color': 'green', 'border-color': 'grey',
                                                   'text-align': 'center', 'opacity': 0.9, 'margin-right': '40px'}),
                                html.Button('Cancel', id='close_modal_btn2_cb',
                                            style={'color': 'black', 'width': '100px', 'margin-top': '10px',
                                                   'background-color': 'red', 'border-color': 'grey',
                                                   'text-align': 'center', 'opacity': 0.9}),
                            ],
    ...
    html.Div(
            id='Insert_data_cable_data3',
            style={'display': 'none', 'position': 'fixed', 'top': '50%', 'left': '50%',
                   'transform': 'translate(-50%, -50%)', 'z-index': 1000},
            children=[
                html.Div(
                    id='modal_content3_cb',
                    style={'background-color': 'white', 'padding': '20px', 'border': '1px solid #ccc',
                    ...
                    children=[
                        ...
                        html.Button('+', id='add_row_btn_cb', n_clicks=0, style={'margin-top': '10px'}),

                        html.Div(
                            children=[
                                html.Button('Confirm', id='save_modal_btn3_cb',
                                            style={'color': 'black', 'width': '100px', 'margin-top': '10px',
                                                   'background-color': 'green', 'border-color': 'grey',
                                                   'text-align': 'center', 'opacity': 0.9, 'margin-right': '40px'}),
                                html.Button('Cancel', id='close_modal_btn3_cb',
                                            style={'color': 'black', 'width': '100px', 'margin-top': '10px',
                                                   'background-color': 'red', 'border-color': 'grey',
                                                   'text-align': 'center', 'opacity': 0.9}),
                            ],
    ...
    html.Div(
            id='Insert_data_cable_data_online_pd1',
            style={'display': 'none', 'position': 'fixed', 'top': '50%', 'left': '50%',
                   'transform': 'translate(-50%, -50%)', 'z-index': 1000},
            children=[
                html.Div(
                    id='modal_content4_cb',
                    style={'background-color': 'white', 'padding': '20px', 'border': '1px solid #ccc',
                           'border-radius': '5px'},
                    children=[
                        ...
                        html.Div(
                            children=[
                                html.Button('Next', id='open_modal_btn_onlinepd2_cb',
                                            style={'color': 'black', 'width': '100px', 'margin-top': '10px',
                                                   'background-color': 'green', 'border-color': 'grey',
                                                   'text-align': 'center', 'opacity': 0.9, 'margin-right': '40px'}),
                                html.Button('Cancel', id='close_modal_btn_onlinepd1_cb',
                                            style={'color': 'black', 'width': '100px', 'margin-top': '10px',
                                                   'background-color': 'red', 'border-color': 'grey',
                                                   'text-align': 'center', 'opacity': 0.9}),
                            ],
    ...
    html.Div(
            id='Insert_data_cable_data_online_pd2',
            style={'display': 'none', 'position': 'fixed', 'top': '50%', 'left': '50%',
                   'transform': 'translate(-50%, -50%)', 'z-index': 1000},
            children=[
                html.Div(
                    id='modal_content5_cb',
                    style={'background-color': 'white', 'padding': '20px', 'border': '1px solid #ccc',
                           'border-radius': '5px'},
                    children=[
                        html.H5('Which Cable?',
                        ...
                        html.Div(
                            children=[
                                html.Button('Next', id='open_modal_btn_onlinepd3_cb',
                                            style={'color': 'black', 'width': '100px', 'margin-top': '10px',
                                                   'background-color': 'green', 'border-color': 'grey',
                                                   'text-align': 'center', 'opacity': 0.9, 'margin-right': '40px'}),
                                html.Button('Cancel', id='close_modal_onlinepd2_cb',
                                            style={'color': 'black', 'width': '100px', 'margin-top': '10px',
                                                   'background-color': 'red', 'border-color': 'grey',
                                                   'text-align': 'center', 'opacity': 0.9}),
                            ],
    ...
    html.Div(
            id='Insert_data_cable_data_online_pd3',
            style={'display': 'none', 'position': 'fixed', 'top': '50%', 'left': '50%',
                   'transform': 'translate(-50%, -50%)', 'z-index': 1000},
            children=[
                html.Div(
                    id='modal_content6_cb',
                    style={'background-color': 'white', 'padding': '20px', 'border': '1px solid #ccc',
                           'border-radius': '5px'},
                    children=[
                        ...
                        html.Div(
                            ...
                            children=[
                            html.Img(
                                src='/assets/hfct_cable.png',  # Replace with your image path
                        ...
                        html.Div(
                            children=[
                                html.Button('Start', id='start_online_btn_onlinepd_cb',
                                            style={'color': 'black', 'width': '100px', 'margin-top': '10px',
                                                   'background-color': 'green', 'border-color': 'grey',
                                                   'text-align': 'center', 'opacity': 0.9, 'margin-right': '40px'}),
                                html.Button('Cancel', id='close_modal_onlinepd3_cb',
                                            style={'color': 'black', 'width': '100px', 'margin-top': '10px',
                                                   'background-color': 'red', 'border-color': 'grey',
                                                   'text-align': 'center', 'opacity': 0.9}),
                            ],
        ...
        html.Div(
            id='Insert_data_cable_data_online_progress',
            style={'display': 'none', 'position': 'fixed', 'top': '50%', 'left': '50%',
                   'transform': 'translate(-50%, -50%)', 'z-index': 1000},
            children=[
                html.Div(
                    id='modal_content_progress_cb',
                    style={'background-color': 'white', 'padding': '20px', 'border': '1px solid #ccc',
                           'border-radius': '5px'},
                    children=[
                        html.H5('Processing...',
                        ...
                        html.Div(
                            children=[
                                html.Button('Close', id='close_progress_modal_cb',
                                            style={'color': 'black', 'width': '100px', 'margin-top': '10px',
                                                   'background-color': 'red', 'border-color': 'grey',
                                                   'text-align': 'center', 'opacity': 0.9}),
                            ],
...
@callback(
    Output('content-cable-raw-data', 'children'),
    Input('store', 'data'),
...
@callback(
    Output('raw_data_summary_cb','data'),
    Input('dummy_table_raw_data_cable', 'children'),
    prevent_initial_call='initial_duplicate'
)
def display_selected_asset(selected_asset):
        ...
        try:
            ...
            for i in range(len(data_lists[0])):  # Assuming all lists have the same length
                entry = {
                    ...
                    "core_number": data_lists[0][i][2],  # Core from the first list
                    ...
                    "latest_jacket": data_lists[2][i][3],  # Jacket from the fourth list
                    "latest_td": data_lists[3][i][3],  # VLF TD from the fourth list (same as Jacket)
                    "latest_pd": 'NA'  # Set as NA
                }
                data.append(entry)
        except ValueError:
            entry = {
                "phase": 'NA',  # Phase from the first list
                "core_number": 'NA',  # Core from the first list
                "latest_test_date": 'NA',
                "latest_ir":'NA',  # Insulation resistance from the second list
                "latest_pi": 'NA',  # Polarization index from the third list
                "latest_jacket": 'NA',  # Jacket from the fourth list
                "latest_td": 'NA',  # VLF TD from the fourth list (same as Jacket)
                "latest_pd": 'NA'  # Set as NA
            }
            data.append(entry)
        return data
    ...
    try:
        ...
        cable_type = asset_selected_details[0]['points'][0]['customdata'][8]
        number_of_cores = asset_selected_details[0]['points'][0]['customdata'][10]
    except IndexError:
        asset_id = None
        cable_type = None
    ...
    if asset_id is not None:
        number_of_cores_phase = 0
        if cable_type =='1C':
            number_of_cores_phase = int(number_of_cores)*3

        if cable_type =='3C':
            number_of_cores_phase = int(number_of_cores)

        # get data
        latest_jt = get_offline_latest_JT_value_for_summary_table(asset_id, number_of_cores_phase)
        latest_ir = get_offline_latest_IR_value_for_summary_table(asset_id, number_of_cores_phase)
        latest_pi = get_offline_latest_PI_value_for_summary_table(asset_id, number_of_cores_phase)
        latest_td = get_offline_latest_TD_value_for_summary_table(asset_id, number_of_cores_phase)

        # create the data set

        data_list = [latest_ir, latest_pi, latest_jt, latest_td]
...
#online
@callback(
    Output('online-container-cable', 'children', allow_duplicate=True),
    [Input('online-button-cable', 'n_clicks')],
    prevent_initial_call='initial_duplicate'
)
def update_online_container(n_clicks):
    ...
    if n_clicks:
        ...
        if graph_visibility['online']:
            ...
            group_labels = {
                20: ('Online PD', 'ONPD'),
                21: ('Distributed Temperature', 'DTS'),
                22: ('Thermal Imaging', 'TI')
            }
            ...
            graph = dcc.Graph(figure=fig, id='online-results-trend-cable',  config={'displayModeBar': False}, style={'margin-top':'30px', 'padding':'10px'})  # Hide modebar buttons
            return graph
        else:
            return None
    else:
...
#offline
@callback(
    Output('offline-container-cable', 'children', allow_duplicate=True),
    [Input('offline-button-cable', 'n_clicks')],
    prevent_initial_call='initial_duplicate'
)
def update_offline_container(n_clicks):
    ...
    if n_clicks:
        ...
        if graph_visibility['offline']:
            ...
            group_labels = {
                14: ('Jacket', 'JT'),
                15: ('Insulation Resistance', 'IR'),
                16: ('Polarization Index', 'PI'),
                17: ('VLF TD', 'TD'),
                18: ('VLF TD','OFPD')
            }
            ...
            graph = dcc.Graph(figure=fig, id='offline-results-trend-cable', config={'displayModeBar': False},style={'margin-top':'30px','padding':'10px'})  # Hide modebar buttons
            return graph
        else:
            return None
    else:
...
#change style button
@callback(
    [Output('online-button-cable', 'style'),
     Output('offline-button-cable', 'style'),
     Output('graph_card', 'style', allow_duplicate=True),
     Output('raw-data-graph-container-cable', 'style', allow_duplicate=True)],
    [Input('online-button-cable', 'n_clicks'),
     Input('offline-button-cable', 'n_clicks')],
    prevent_initial_call='initial_duplicate'
)
...
# #raw data graph
@callback(
    Output('raw-data-graph-container-cable', 'children', allow_duplicate=True),
    Output('raw-data-graph-container-cable', 'style', allow_duplicate=True),
    Output('offline-button-cable', 'disabled'),
    Input('online-results-trend-cable', 'clickData'),
    prevent_initial_call='initial_duplicate'
)
def update_graph_container(clickData):
    ...
    for diagnostic_test_id in (20, 21, 22):
        # online
        if diagnostic_test_id==20:
            raw_data = get_online_pd_test_data_cable(asset_id=asset_selected_details[0]['points'][0]['customdata'][0])
            ...
            data_df['Amplitude'] = pd.to_numeric(data_df['Amplitude'], errors='coerce')

            # Drop NaNs in 'Amplitude'
            data_df = data_df.dropna(subset=['Amplitude'])

            # Sort DataFrame by 'Date' to ensure chronological order
            data_df = data_df.sort_values(by='Date', ascending=False)

            # Create a new column for the label combining Phase and Core
            data_df['Label'] = data_df.apply(lambda x: f"Phase: {x['Phase']}, Core: {x['Core']}", axis=1)
            ...
            if not data_df.empty:
                # Create an empty figure for
                # print(data_df)
                fig = px.scatter(data_df, x='Date', y='Amplitude', color='Phase',
                                 labels={'Amplitude': 'Amplitude [mV]', 'Phase': 'Phase'},
                                 title='Online PD Data Trend', color_discrete_sequence=color_sequence,
                                 hover_data={'Phase': True, 'Core': True},
                                 custom_data=['pdpattern_id'])
                ...
                # Create line plots for each unique Phase and Core combination
                for phase in data_df['Phase'].unique():
                    for core in data_df['Core'].unique():
                        # Filter data for the specific Phase and Core
                        group_data = data_df[(data_df['Phase'] == phase) & (data_df['Core'] == core)]

                        if not group_data.empty:
                            # Create line plot for this group
                            line_fig = px.line(group_data, x='Date', y='Amplitude',
                                               labels={'Amplitude': 'Amplitude [mV]', 'Phase': 'Phase'},
                                               title=f'Trend for Phase: {phase}, Core: {core}',
                                               color_discrete_sequence=[color_map.get(phase, '#FFFFFF')],
                                               markers=True,hover_data={'Phase': True, 'Core': True},
                                               custom_data=['pdpattern_id'])


                            #
                            # Add line plot traces to the main figure
                            for trace in line_fig.data:
                                fig.add_trace(trace)

                # Scale
                max_value = data_df['Amplitude'].max()
                full_scale = max_value * 1.2

                # Update layout for centering the title and customizing appearance
                fig.update_layout(
                    title={
                        'text': 'Online PD Test Trend',
                        'x': 0.5,
                        'xanchor': 'center',
                        'yanchor': 'top',
                        'font': {'size': 14}
                ...
                graph1 = dcc.Graph(figure=fig,id='pd_trend_cable', style={'padding': '10px'}, config={'displayModeBar': False})


    return dbc.Container([graph1], fluid=True), {'display': 'block', 'margin-top':'30px', 'width':'100%'}, True
#
...
@callback(
    ...
    Input('pd_trend_cable', 'clickData'),
    prevent_initial_call='initial_duplicate'
)
def update_graph_container(clickData):
    def get_image_from_db(pdpattern_id):
        # Fetch your image from MySQL
        image_data = get_online_pd_patter_cable(pdpattern_id)[0]
    ...
    if clickData is None:
        ...
        # Extract information from the clicked marker
    pdpattern_id = clickData['points'][0]['customdata'][0]
    ...
    identification_label = html.P(f'Identification: {pdpattern_id}', style={'fontSize': '12px'})

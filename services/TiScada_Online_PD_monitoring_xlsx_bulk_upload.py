...
for index, row in enumerate(date_list_ch1):
    ...
    data = [
        ...
        (date_list_notime_ch2[index], asset_id,subcomponet_id,diagnostic_test_id, phase_tag_list_ch2[index], round(qmax95_list_ch2[index]*1000,2), round(nw_list_ch2[index],2),round(synch_freq_list_ch2[index]), Monitoring, monitoring_type, connection_type, date_list_ch2[index]),
